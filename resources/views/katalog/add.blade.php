...
<div class="container-fluid content p-4">
    <div class="container bg-light p-4">
        <form method="POST" action="{{ route('katalog.store') }}" class="needs-validation" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input id="tautan" type="text" class="form-control @error('tautan') is-invalid @enderror" name="tautan" required autocomplete="false" autofocus aria-describedby="tautanHelp" placeholder="https://namawebsite.com">
